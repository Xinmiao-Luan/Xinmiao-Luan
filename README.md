...
- 🔹 **Teaching Materials for IEE 572 (Design Engineering Experiments)**  
  [Link](https://www.coursera.org/specializations/design-experiments) · Supporting 120+ students with **Python & JMP examples** in each semester
...
- [More coming soon →] Luan, X. et al. *An exploratory analysis of ultrasound signatures in direct energy deposition building processes.*, Luan, X. et al. *MT-SR-GMM: A Multi-Task Structure-Regularized Gaussian Mixture Model for Robust Cluster Analysis in Manufacturing Process.*
